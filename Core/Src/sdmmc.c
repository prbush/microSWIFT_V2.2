...
/* USER CODE BEGIN 0 */
static bool sdmmc1_init_status = false;
/* USER CODE END 0 */
...
void HAL_SD_MspInit(SD_HandleTypeDef* sdHandle)
{
  ...
  */
    ...
    PD2     ------> SDMMC1_CMD
    */
    GPIO_InitStruct.Pin = SD_CARD_D0_Pin|GPIO_PIN_9|GPIO_PIN_10|GPIO_PIN_11
                          |SD_CARD_SCK_Pin;
...
void HAL_SD_MspDeInit(SD_HandleTypeDef* sdHandle)
{
  ...
  /* USER CODE END SDMMC1_MspDeInit 0 */
    ...
    PD2     ------> SDMMC1_CMD
    */
    HAL_GPIO_DeInit(GPIOC, SD_CARD_D0_Pin|GPIO_PIN_9|GPIO_PIN_10|GPIO_PIN_11
                          |SD_CARD_SCK_Pin);
...
int32_t sdmmc1_init ( void )
{
  ...
  sdmmc1_init_status = (ret == SDMMC_OK);
  return ret;
}
